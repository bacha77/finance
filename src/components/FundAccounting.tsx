                                        ...
                                        <div style={{ maxHeight: '200px', overflowY: 'auto', marginBottom: '1rem', paddingRight: '4px' }}>
                                            {allocations.map((alloc, idx) => (
                                                <div key={idx} style={{ display: 'flex', gap: '0.5rem', marginBottom: '0.8rem', alignItems: 'flex-end' }}>
                                                    ...
                                                    <div style={{ flex: 1 }}>
                                                        {idx === 0 && <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 600, color: 'var(--text-muted)', marginBottom: '6px', textTransform: 'uppercase' }}>Destination Fund <span style={{ color: '#ef4444' }}>*</span></label>}
                                                        <select
                                                            value={alloc.fundId}
